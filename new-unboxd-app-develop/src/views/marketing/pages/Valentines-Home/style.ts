...
import LoveBg from '../../../../assets/img/illustrations/love-bg.svg';
...
export const XContainerFooter = Styled.div`
  width: 100%;
...
export const FooterCaveat = Styled.div`
  display: flex;
  flex-direction: column;
  justify-content: space-between;
  gap: 20px;
